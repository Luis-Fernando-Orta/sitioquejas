    ...
    <main>
        ...
        <div class="container table-responsive tablaR">
            <table class="table" id="example">
                <caption class="caption-top">Lista de empleados</caption>
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td><img src="imgVendedores/<?php echo $bd2['imagen'];?>" class="w-75" alt=""></td>
                        <td><?php echo $bd2 ['telefono'];?></td>
                        <td><?php echo $bd2 ['correo'];?></td>
                        <td><a href="BDEliminarEmpleado.php?id_vendedor=<?php echo $bd2 ['id_vendedor']?>"
