    ...
    <div class="container breadDetalles">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="aTipos.php">Lista de tipos</a></li>
                <li class="breadcrumb-item">Editar tipo</li>
            </ol>
        </nav>
    </div>
        ...
        <section>
            <div class="container">
                <div class="d-flex justify-content-center">
                    <span class="fw-bold fs-2">Modificar tipo</span>
                </div>
            </div>
            <hr class="container w-50">
            <br>
            <form action="BDActualizarTipo.php" class="form-floating" method="post">
                ...
                <div class="container text-center row">
                    ...
                    ?>
                    <div class="col">
                        <input type="text" value="<?php echo $row["id_marca"] ?>" name="id_marca" hidden>
                        <div class="form-floating">
                            <input type="text" class="form-control" id="nombreM" name="nombreM" maxlength="20"
                                value="<?php echo $row["nombreM"] ?>" placeholder="xxxxxxx">
                            <label for="floatingPassword">Nombre del tipo</label>
                        </div>
                        <br>
                    </div>
                    <div class="col"></div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button class="btn" id="btnbuscador" onclick="validarMarca(event)">Actualizar</button>
                    </div>
                </div>
            </form>
        </section>
